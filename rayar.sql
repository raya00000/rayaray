...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 08 Agu 2024 pada 10.22
...
(1, 'administrator', 'admin', '0192023a7bbd73250516f069df18b500', 'admin@gmail.com', 'cibatu', '08123456789', 'admin');
...
ALTER TABLE `ulasan`
  ...
  ADD CONSTRAINT `ulasan_ibfk_4` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`);
COMMIT;
